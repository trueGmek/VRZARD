...
namespace Valve.VR.InteractionSystem {
    ...
    public class Interactable : MonoBehaviour {
        ...
        [NonSerialized] public List<Hand> hoveringHands = new List<Hand>();
        ...
        /// </summary>
        private LayerMask _previousLayer;
        ...
        protected virtual void OnHandHoverBegin(Hand hand) {
            ...
            if (highlightOnHover && wasHovering == false) {
                // _previousLayer = gameObject.layer;
                // if (_previousLayer != 13) {
                //     gameObject.layer = 14;
                // }
            }
        }
        ...
        protected virtual void OnAttachedToHand(Hand hand) {
            ...
            if (onAttachedToHand != null) {
                ...
                // Grid.DataExporter.NoteEvent(gameObject.name + " was attached to the hand " + hand.handType);
            }
